...
public class UDPSendTest : MonoBehaviour
{
    ...
    [SerializeField] private VehicleController trailer;
   ...
   public void ResertPositionEngine ()
    ...
    void FixedUpdate()
    {
        float A1 = trailer.initialRotations.x ;
        float B1 = trailer.initialRotations.y ;
        float C1 = trailer.initialRotations.z;
